...
public class StatsQuery {
	...
	public static final String SELECT_STATS_ONE = "SELECT day, cnt FROM stats WHERE day = ?";
	public static final String SELECT_STATS_TOTAL = "SELECT SUM(cnt) FROM stats";
	public static final String INSERT_STATS_COUNT_ONE = "INSERT INTO stats(day, cnt) VALUES(?, 1)";
	public static final String UPDATE_STATS_PLUS_ONE = "UPDATE stats SET cnt = cnt+1 WHERE day = ?";
}
